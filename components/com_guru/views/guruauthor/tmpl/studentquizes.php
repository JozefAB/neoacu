                            ...
                            <tr class="guru_row">
                                ...
                                <td class="g_cell_6">
                                    <?php
                                        if(trim($quiz["final_score"]) != "" && intval($quiz["final_score"]) != 0){
                                    ?>
                                            <input type="button" class="uk-button uk-button-success" onclick="window.location='<?php echo JURI::root()."index.php?option=com_guru&view=guruauthor&task=quizdetails&layout=quizdetails&pid=".intval($pid)."&userid=".intval($userid)."&quiz=".intval($quiz["id"]); ?>&tmpl=component'" value="<?php echo JText::_("GURU_DETAILS"); ?>" />
                                    <?php
                                        }
                                    ?>        
                                </td>
