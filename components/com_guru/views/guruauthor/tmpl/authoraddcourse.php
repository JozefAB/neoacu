    ...
    ?>
            <form action="<?php echo JURI::root(); ?>index.php?option=com_guru?view=guruAuthor" class="uk-form uk-form-horizontal" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
                ...
                <ul class="uk-subnav uk-subnav-pill">
                	<li><input type="button" class="uk-button uk-button-success" value="<?php echo JText::_("GURU_SAVE"); ?>" onclick="javascript:saveCourse('apply');" /></li>
					<li><input type="button" class="uk-button uk-button-success" value="<?php echo JText::_("GURU_SAVE_AND_CLOSE"); ?>" onclick="javascript:saveCourse('save');" /></li>
					<li><input type="button" class="uk-button uk-button-primary" value="<?php echo JText::_("GURU_CLOSE"); ?>" onclick="document.location.href='<?php echo JRoute::_("index.php?option=com_guru&view=guruauthor&task=authormycourses&layout=authormycourses"); ?>';" /></li>
                </ul>
                <br/>
                <ul data-uk-switcher="{connect:'#subnav-pill-content-1'}" class="uk-subnav uk-subnav-pill">
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls">
                                <?php 
                                    ...
                                    echo JHTML::_('calendar', $start_publish, 'startpublish', 'startpublish', $format, array('class'=>'uk-float-left', 'size'=>'25',  'maxlength'=>'19'));
								?>
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls">
                                <?php
									...
									$calendar = JHTML::_('calendar', $end_publish, 'endpublish', 'endpublish', $format, array('class'=>'uk-float-left', 'size'=>'25',  'maxlength'=>'19'));
									if(substr($program->endpublish, 0, 4) == '0000' || $program->id < 1){
                    	...
                    	<?php if($config->course_is_free_show == 1){?>
                      	<div class="uk-clearfix">
                           <div class="uk-float-left">
                            ...
                            <div class="uk-float-left" style="padding-left:10px;"><?php echo trim(JText::_('GURU_FREE_COURSES')); ?></div>
                            ...
                            <div class="uk-float-left">
                             ...
                             <div class="uk-float-left" id="free_courses"> 
                            ...
                            <div class="uk-float-left" id="members-list" style="display:<?php echo $display; ?>;">
                                <?php
                                    $groups = array();
