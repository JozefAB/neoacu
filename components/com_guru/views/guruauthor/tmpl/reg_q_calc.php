...
<div id="g_myquizzesaddedit" class="clearfix com-cont-wrap">
    ...
    <ul class="uk-subnav uk-subnav-pill">
        <li><input type="button" class="uk-button uk-button-success" value="<?php echo JText::_("GURU_SAVE"); ?>" onclick="javascript:save_quizFE('apply_quizFE');" /></li>
        <li><input type="button" class="uk-button uk-button-success" value="<?php echo JText::_("GURU_SAVE_AND_CLOSE"); ?>" onclick="javascript:save_quizFE('save_quizFE');" /></li>
