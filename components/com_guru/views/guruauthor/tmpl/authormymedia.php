...
$page_from = JRequest::getVar("page_from","");
$tmpl_comp =  JRequest::getVar("tmpl","");
...
<div class="gru-mycoursesauthor">
    ...
    <?php if($page_from != 'question' && $tmpl_comp !='component'){?>
			<ul class="uk-subnav uk-subnav-pill">
               ...
               <?php }?>
                <li><button class="uk-button" onclick="duplicateMedia();"><?php echo JText::_('GURU_DUPLICATE'); ?></button></li>
                <li><button class="uk-button uk-button-danger" onclick="deleteAuthorMedia();"><?php echo JText::_('GURU_DELETE'); ?></button></li>
            </ul>
            
            <h2 class="gru-page-title"><?php echo JText::_('GURU_AUTHOR_MY_MEDIA');?></h2>
        ...
        <form  action="index.php" class="form-horizontal" id="adminForm" method="post" name="adminForm" enctype="multipart/form-data">
			...
			?>
            		<div class="gru-page-filters">
                        ...
                        <div class="gru-filter-item">
                        	<input type="text" class="form-control" name="search_media" id="filter_search" value="<?php if(isset($_POST['search_media'])) echo $_POST['search_media'];?>" class="uk-form-width-medium" />
                         ...
                         <?php 
                            ...
                            ?>
                                ...
                                <?php
                                    ...
                                    $radio_value = JRequest::getVar("radio_value", "0");
                                ?>
