...
<div id="g_myquizzesfeaddedit" class="gru-myquizzesfeaddedit">
    ...
    <ul class="uk-subnav uk-subnav-pill">
        <li><input type="button" class="uk-button uk-button-success" value="<?php echo JText::_("GURU_SAVE"); ?>" onclick="javascript:savequiz('apply_quizFE');" /></li>
        <li><input type="button" class="uk-button uk-button-success" value="<?php echo JText::_("GURU_SAVE_AND_CLOSE"); ?>" onclick="javascript:savequiz('save_quizFE');" /></li>
        <li><input type="button" class="uk-button uk-button-primary" value="<?php echo JText::_("GURU_CLOSE"); ?>" onclick="document.location.href='<?php echo JRoute::_("index.php?option=com_guru&view=guruauthor&task=authorquizzes&layout=authorquizzes"); ?>';" /></li>
    </ul>
                ...
                <table class="uk-table uk-table-striped">                  
                    ...
                    $hide_q2del = explode(',', $hide_q2del);
                     ...
                     for ($i = 0; $i < count($result_name); $i++){ 
                        $link2_remove = '<span class="btn btn-danger" onClick="delete_fq('.$result_name[$i]["id"].','.intval(@$_GET['cid']).', 1)">Remove</span>';
