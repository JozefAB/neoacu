...
function validateAuFormAjaxButton(){
	...
	if(document.getElementById("input-captcha").value != document.getElementById("cptchd").value){
		alert("<?php echo JText::_("GURU_INVALID_CAPTCHA"); ?>");
		return false;
	}
...
function refreshcaptcha(){
	...
	document.getElementById('cptka2').innerHTML = '<img align="absbottom" alt="code" id="cptka" src="<?php echo JURI::root()."components/com_guru/views/gurulogin/tmpl/captcha.php?code=";?>'+randstr+'" />';
    ...
    <form class="uk-form uk-form-horizontal" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" onsubmit="return validateTerms()">
		...
		?>
                <ul class="uk-tab" data-uk-tab="{connect:'#tab-content'}">
                    ...
                    <li class=""><a href="#"><?php echo JText::_("GURU_PHOTO_TAB");?></a></li>
                    <li class=""><a href="#"><?php echo JText::_("GURU_BIO");?></a></li>
                </ul>
                ...
                <ul class="uk-switcher uk-margin" id="tab-content">
					<li class="uk-active uk-margin-top">
                        ...
                        ?>
                                <div class="uk-form-row">
                                    <label class="uk-form-label" for="name">
                                        <?php echo JText::_("JS_CAPTCHA");?>:
                                        <span class="uk-text-danger">*</span>
                                    </label>
                                    <div class="uk-form-controls">
                                        <input type="text" id="input-captcha" name="captcha" size="12" maxlength="6" value="" />&nbsp;&nbsp;
                                        <span id="cptka2">
                                            <img align="absbottom" alt="code" id="cptka" src="<?php echo JURI::root()."components/com_guru/views/gurulogin/tmpl/captcha.php?code=".$code;?>" />
                                        </span>
                                        <input type="hidden" id="cptchd" value="<?php echo $code; ?>" />
                                        &nbsp;&nbsp;
                                        <img align="absbottom" style="cursor:pointer;" alt="refresh_captcha" onClick="refreshcaptcha()" src="<?php echo JURI::root()."components/com_guru/images/recaptcha_refresh.png";?>" />
                                    </div>
                                </div>
                        <?php
                            }
