        ...
        <li>
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
					...
					echo JHTML::_('calendar', $start_publish, 'startpublish', 'startpublish', $format, array('maxlength'=>'19')); ?>
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
					...
					$calendar =  JHTML::_('calendar', $end_publish, 'endpublish', 'endpublish', $format, array('maxlength'=>'19')); 
					if(substr($end_publish, 0, 4) == '0000' || $end_publish == JText::_('GURU_NEVER') || $end_publish == ""){
