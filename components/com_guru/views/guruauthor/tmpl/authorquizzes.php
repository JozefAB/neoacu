...
<div id="g_myquizzesauthor" class="clearfix com-cont-wrap">
    ...
    <div class="g_inline_child clearfix">
        ...
        ?> 
			<li><button class="uk-button" onclick="duplicateQuiz();"><?php echo JText::_('GURU_DUPLICATE'); ?></button></li>
			<li><button class="uk-button uk-button-danger" onclick="deleteQuiz();"><?php echo JText::_('GURU_DELETE'); ?></button></li>
		</ul>
	</div>
    <!-- -->
    
    <h2 class="gru-page-title"><?php echo JText::_('GURU_AUTHOR_MY_QUIZZES');?></h2>
    ...
    <div id="g_myquizzesauthorcontent" class="g_sect clearfix">
        <form class="form-horizontal" id="adminForm" method="post" name="adminForm" enctype="multipart/form-data" action="index.php" style="padding-top:10px;">
            <div class="gru-page-filters">
                ...
                <div class="gru-filter-item">
                    <input type="text" class="form-control" name="search_quiz" id="filter_search" value="<?php if(isset($_POST['search_quiz'])){echo $_POST['search_quiz'];} ?>" class="uk-form-width-medium" />
