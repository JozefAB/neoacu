...
?>
	...
	<form class="uk-form uk-form-horizontal <?php echo $margin_form; ?>" action="index.php" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
         <?php
            if($tmpl != "component"){
        ?>
        ...
        <div class="uk-form-row">
            ...
            <div class="uk-form-controls">
                ...
                <div class="uk-margin-left uk-float-left">
        ...
        <div class="uk-form-row" id="display_docs" style="display:<?php echo $display_docs; ?>">
            <label for="name" class="uk-form-label">
        ...
        <div class="uk-form-row" id="videoblock" <?php echo $stylev; ?>>
            <label for="name" class="uk-form-label">
            ...
            <div class="uk-form-controls">
                ...
                <ul class="uk-switcher uk-margin" id="tab-content">
					<li class="<?php echo $tab_active1; ?> uk-margin-top">
                    ...
                    <li class="<?php echo $tab_active2; ?> uk-margin-top">
						<div class="uk-grid">
                        	...
                        	<div class="uk-width-1-1">
                        		<input type="text" value="<?php echo $_row->url; ?>" name="url_v" id="url_v" class="uk-form-width-large" onPaste="javascript:change_radio_url()" onblur="javascript:addVideoFromUrl('<?php echo JURI::root(); ?>');" />
                        	</div>
						</div>
                        
                        <div class="uk-grid">
                        	<div class="uk-width-1-1">
                                <div class="form-helper uk-float-left">
                        ...
                        <div class="uk-grid">
                        	<div class="uk-width-1-1">
                            	<input type="button" class="uk-button uk-button-success" value="<?php echo JText::_("COM_GURU_GET_VIDEO_NFO"); ?>" name="video-info" onclick="javascript:addVideoFromUrl('<?php echo JURI::root(); ?>');" />
                        	</div>
                        ...
                        <div class="uk-float-left" id="progress-video-upload" style="display:none; clear: both; margin-top:10px;">
                    ...
                    <li class="<?php echo $tab_active3; ?> uk-margin-top">
                    	<div id="video_add_from_upload" class="uk-float-left">
                    ...
                    <li class="<?php echo $tab_active4; ?> uk-margin-top">
                    	<div id="video_add_from_existings" class="uk-float-left">
        ...
        <div class="uk-form-row" id="audioblock" <?php echo $stylea; ?>>
            <label for="name" class="uk-form-label">
            ...
            <div class="uk-form-controls">
                ...
                ?>
                <ul class="uk-tab" data-uk-tab="{connect:'#tab-content-audio'}">
                ...
                <ul class="uk-switcher uk-margin" id="tab-content-audio">
					<li class="<?php echo $tab_active1a; ?> uk-margin-top">
                    ...
                    <li class="<?php echo $tab_active2a; ?> uk-margin-top">
                    	<?php echo JText::_('GURU_MEDIATYPEAUDIO').' '.JText::_('GURU_MEDIATYPEURLURL');?>
                        &nbsp;&nbsp;
                        <input type="text" class="uk-form-width-large" value="<?php echo $_row->url;?>" name="url_a"/>
                        <span class="editlinktip hasTip" title="<?php echo JText::_("GURU_TIP_MEDIATYPEAUDIO"); ?>" >
                            <img border="0" src="components/com_guru/images/icons/tooltip.png">
                        </span>
                    </li>
                    
                    <li class="<?php echo $tab_active3a; ?> uk-margin-top">
                    	<?php echo JText::_("GURU_LOCAL"); ?>
                        &nbsp;&nbsp;
                    ...
                    <li class="<?php echo $tab_active4a; ?> uk-margin-top">
		...
		<div class="uk-form-row" id="docsblock" <?php echo $styled; ?>>
            <label for="name" class="uk-form-label">
            ...
            <div class="uk-form-controls">
                ...
                ?>
               	<ul class="uk-tab" data-uk-tab="{connect:'#tab-content-doc'}">
                ...
                <ul class="uk-switcher uk-margin" id="tab-content-doc">
					<li class="<?php echo $tab_active2d; ?> uk-margin-top">
                    	<?php echo JText::_('GURU_MEDIATYPEDOCS').' '.JText::_('GURU_MEDIATYPEURLURL');?>
                        &nbsp;&nbsp;
                        <input type="text" class="uk-form-width-large" value="<?php echo $_row->url;?>" name="url_d"/>
                        <span class="editlinktip hasTip" title="<?php echo JText::_("GURU_TIP_MEDIATYPEDOCS"); ?>" >
                            <img border="0" src="components/com_guru/images/icons/tooltip.png">
                        </span>
                    </li>
                    
                    <li class="<?php echo $tab_active3d; ?> uk-margin-top">
                    	<?php echo JText::_("GURU_LOCAL"); ?>
                        &nbsp;&nbsp;
                        <span class="editlinktip hasTip" title="<?php echo JText::_("GURU_TIP_AUDIO_LOCAL"); ?>" >
                            <img border="0" src="components/com_guru/images/icons/tooltip.png">
                        ...
                        <div class="uk-alert uk-alert-warning"><?php echo JText::_("GURU_ACCEPTED_FILE_TYPES").": txt and pdf"; ?></div>
                        <div class="clearfix"></div>
                    ...
                    <li class="<?php echo $tab_active4d; ?> uk-margin-top">
        ...
        <div id="urlblock" <?php echo $styleu; ?> class="uk-margin-top">
            <div class="uk-form-row">
                <label for="name" class="uk-form-label">
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
					...
					<div style="float:left;">
						<input type="text" style="width:50px;" value="<?php echo $_row->width; ?>" name="width" id="width"/> x
						<input type="text" style="width:50px;" value="<?php echo $_row->height; ?>" name="height" id="height"/> px &nbsp;
					</div>
        ...
        <div class="uk-form-row" id="artblock" <?php echo $styleu; ?>>
        	<label for="name" class="uk-form-label">
        ...
        <div class="uk-form-row" id="imageblock" <?php echo $stylei; ?>>
            <label for="name" class="uk-form-label">
                <?php echo JText::_('GURU_MEDIATYPEIMAGE');?>
                <span class="uk-text-danger">*</span>
            </label>
            <div class="uk-form-controls">
                <div id="imageUploader" class="uk-float-left uk-margin-bottom"></div>
		...
		?>
    	 ...
    	 <div class="uk-form-row" id="textblock" <?php echo $stylet; ?>>
            <label for="name" class="uk-form-label">
            ...
            <div class="uk-form-controls">
				...
				?>
				<textarea id="text" name="text" class="useredactor" style="width:auto; height:100px;"><?php echo $_row->code; ?></textarea>
				...
				<?php
					$upload_script = 'window.addEvent( "domready", function(){
										...
										jQuery(".redactor_useredactor").css("height","300px").css("width", "auto");
									  });';
    	...
    	<div class="uk-form-row" id="fileblock" <?php echo $stylef; ?>>
            <label for="name" class="uk-form-label">
            ...
            <div class="uk-form-controls">
                ...
                <ul class="uk-tab" data-uk-tab="{connect:'#tab-content-file'}">
                ...
                <ul class="uk-switcher uk-margin" id="tab-content-file">
					<li class="<?php echo $tab_active2f; ?> uk-margin-top">
                    	<?php echo JText::_('GURU_FILE').' '.JText::_('GURU_MEDIATYPEURLURL');?>
                        &nbsp;&nbsp;
                        <input type="text" onKeyPress="javascript:change_radio_url();" onPaste="javascript:change_radio_url()" class="uk-form-width-large" value="<?php echo $_row->url;?>" id="url_f" name="url_f"  onChange="javascript:hide_hidden_row();" onmouseout="doPreview();" on/>
                    ...
                    <li class="<?php echo $tab_active3f; ?> uk-margin-top">
                    ...
                    <li class="<?php echo $tab_active4f; ?> uk-margin-top">
