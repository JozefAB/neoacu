...
<div class="gru-course-page">
	<div class="uk-grid">
		<div class="uk-width-1-1">
					...
					<div class="guru-cover-image" <?php echo $style; ?> >
						<div class="<?php echo $course_style->course_name; ?> page_title">
							<h2 class="gru-page-title padding-left-10"><?php echo $program->name; ?></h2>
						</div>
                            <div class="guru-course-details">
                                <?php
                                ...
                                if($course_config->course_author_name_show == "0"){
                                    ...
                                    if(isset($author->name)){
                                        $details .= '<b>'.JText::_("GURU_AUTHOR").': </b>'.implode(", ", $list_author_name).'<br />';
                                    }
                                }
                    ...
                    ?>
                        <div class="uk-alert" id="joomlamessage">
