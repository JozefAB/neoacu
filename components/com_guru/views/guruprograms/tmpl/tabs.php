...
<div><!-- start main div-->
    ...
    <div class="uk-grid">
			...
			<div class="uk-width-1-2 uk-hidden-small hidden-phone">
                ...
                ?>
                        <div class="col_title pull-left uk-width-1-<?php echo intval($nr_columns); ?> uk-text-right">
                            <?php
												...
												<?php
													...
													foreach($lessons as $poz=>$lesson){
														...
														if($lesson["can_open_lesson"] == "1"){ // access to this lesson
															if($config->open_target == 0){ // same window
															...
															elseif($config->open_target == 1){ // modal window
																$link = "#";
												...
												?>
                                                		<li class="uk-grid" <?php echo $style; ?>>
															<div class="uk-width-1-2 lesson_name">
                                                                <a onclick="<?php echo $onclick; ?>" href="<?php echo $link; ?>" <?php echo $style; ?> class="<?php echo $inactive_lesson_class; ?>">
                                                            ...
                                                            <div class="uk-width-1-2">
                                                            	...
                                                            	if(isset($course_config->quiz_status) && $course_config->quiz_status == 0){
															?>
                                                            		<div class="uk-width-1-<?php echo $nr_columns - 1; ?> pull-left uk-text-right">
                                                                        <?php
															...
															?>
                                                                ...
                                                                <div style="visibility:<?php echo $display; ?>;" class="uk-width-1-<?php echo $nr_columns - 1; ?> viewed pull-left uk-text-right">
                                                                    <i class="fa fa-eye"></i>
                                                                </div>
