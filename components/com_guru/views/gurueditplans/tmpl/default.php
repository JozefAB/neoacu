...
<div id="g_content" class="gru-content">
    ...
    if($action == ""){
    ?>
        <form action="<?php echo JRoute::_('index.php?option=com_guru&view=guruEditplans&task=buy&Itemid='.intval($Itemid)); ?>" name="adminForm" method="post" style="padding:10px;">
            ...
            <input type="submit" name="continue" class="uk-button uk-button-success" value="<?php echo JText::_("GURU_CONTINUE_ARROW"); ?>" />
        </form>
    <?php
    }
