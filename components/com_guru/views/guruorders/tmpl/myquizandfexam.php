	...
	<form name="adminForm" method="post" id="adminForm">
        ...
        <div class="gru-page-filters">
        	<div class="gru-filter-item">
                <input type="text" class="form-control uk-form-width-medium" style="margin:0px;" placeholder="<?php echo JText::_("GURU_SEARCH"); ?>" name="search_course" value="<?php if(isset($_POST['search_course'])) echo $_POST['search_course'];?>" >
                    ...
                    foreach($my_quizzes as $key=>$value){
                        ...
                        ?>
                                <tr>
                                    ...
                                    ?>
                                            <a href="<?php echo JRoute::_("index.php?option=com_guru&view=guruPrograms&task=view&cid=".intval($value["pid"])."-".@$alias."&Itemid=".$Itemid); ?>">
                                                <?php echo $coursename; ?>
                                            </a>
                                    <?php
                                        }
                                    ...
                                    <td class="g_cell_5"><?php echo $poz."/".$time_quiz_taken; ?></td>
                                    <td class="g_cell_6 g_hide_mobile"><?php echo $result_maxs."%"; ?></td>
                                    <td class="g_cell_7 ">
                                        <a class="g_hide_mobile" onclick="javascript:openMyModal(0, 0, '<?php echo JURI::root().'index.php?option=com_guru&view=guruauthor&task=student_quizdetails&layout=student_quizdetails&pid='.intval($cid[$key]).'&userid='.intval($user_id).'&quiz='.intval($value_row["quiz_id"]).'&id='.intval($value_row["id"]).'&tmpl=component'; ?>');" href="#">
