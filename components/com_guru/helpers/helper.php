	...
	function createBreacrumbs(){
		...
		if($show_bradcrumbs == "1"){
			...
			if($controller == "guruPcategs" && trim($position) == ""){
				...
				$bradcrumbs .= '<div id="g_breadcrumb" class="uk-grid">';
...
function createThumb($images, $folder, $new_size, $type, $folder_thumbs="thumbs"){
	...
	function createStudentMenu(){
		...
		if($user->id > 0){
			...
			$return_url = base64_encode("index.php?option=com_guru&view=gurupcategs&Itemid=".intval($itemid));
		...
		$return = '
			<nav class="uk-navbar hidden-phone hidden-tablet">
				<ul class="uk-navbar-nav">
					<li id="g_my_profile" '.$g_my_profile.'>
						<a href="'.JRoute::_("index.php?option=com_guru&view=guruProfile&task=edit&Itemid=".intval($Itemid), false).'">
							<i class="fa fa-user"></i>&nbsp;'.JText::_('GURU_MY_ACCOUNT').'
						</a>
					</li>
					
					<li id="g_my_courses_active" '.$g_my_courses.'>
						<a href="'.JRoute::_("index.php?option=com_guru&view=guruorders&layout=mycourses&Itemid=".intval($Itemid), false).'">
							<i class="fa fa-file-o"></i>&nbsp;'.JText::_('GURU_MYCOURSES').'
						</a>
					</li>
					
					<li id="g_my_students" '.$g_my_orders.'>
						<a href="'.JRoute::_("index.php?option=com_guru&view=guruorders&layout=myorders&Itemid=".intval($Itemid), false).'">
							<i class="fa fa-user"></i>&nbsp;'.JText::_('GURU_MYORDERS_MYORDERS').'
						</a>
					</li>
					
					<li id="g_my_quizzes" '.$g_my_quizzes.'>
						<a href="'.JRoute::_("index.php?option=com_guru&view=guruorders&layout=myquizandfexam&Itemid=".intval($Itemid), false).'">
							<i class="fa fa-question-circle"></i>&nbsp;'.JText::_('GURU_QUIZZ_FINAL_EXAM').'
						</a>
					</li>
					<li id="g_my_quizzes" '.$g_my_certificates.'>
						<a href="'.JRoute::_("index.php?option=com_guru&view=guruorders&layout=mycertificates&Itemid=".intval($Itemid), false).'">
			...
			$return .= '<div id="guru_menubar_mobile" class="uk-hidden-large uk-hidden-medium">
							<select name="menu_bar" onchange="document.location.href = this.value">
								<option '.$menu_g_my_profile.' value="'.JRoute::_("index.php?option=com_guru&view=guruProfile&task=edit&Itemid=".intval($Itemid), false).'">'.JText::_("GURU_MY_ACCOUNT").'</option>
								<option '.$menu_g_my_courses.' value="'.JRoute::_("index.php?option=com_guru&view=guruorders&layout=mycourses&Itemid=".intval($Itemid), false).'">'.JText::_("GURU_MYCOURSES").'</option>
								<option '.$menu_g_my_orders.' value="'.JRoute::_("index.php?option=com_guru&view=guruorders&layout=myorders&Itemid=".intval($Itemid), false).'">'.JText::_("GURU_MYORDERS_MYORDERS").'</option>
								<option '.$menu_g_my_quizzes.' value="'.JRoute::_("index.php?option=com_guru&view=guruorders&layout=myquizandfexam&Itemid=".intval($Itemid), false).'">'.JText::_("GURU_QUIZZ_FINAL_EXAM").'</option>
								<option '.$menu_g_my_certificates.' value="'.JRoute::_("index.php?option=com_guru&view=guruorders&layout=mycertificates&Itemid=".intval($Itemid), false).'">'.JText::_("GURU_MYCERTIFICATES").'</option>
							</select>
						</div>';
		return $return;
	}
