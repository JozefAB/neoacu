...
class guruAdminControllerguruTasks extends guruAdminController {
	...
	function ajax_request(){
		include_once(JPATH_SITE.DS."administrator".DS."components".DS."com_guru".DS."views".DS."gurutasks".DS."tmpl".DS."ajax.php");
		die();
	}
	
	function ajax_request2(){
		include_once(JPATH_SITE.DS."administrator".DS."components".DS."com_guru".DS."views".DS."gurutasks".DS."tmpl".DS."ajaxAddMedia.php");
		die();
	}
	
	function ajax_request3(){
		include_once(JPATH_SITE.DS."administrator".DS."components".DS."com_guru".DS."views".DS."gurutasks".DS."tmpl".DS."ajaxAddText.php");
		die();
	}
};
?>