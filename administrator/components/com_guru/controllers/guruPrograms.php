...
class guruAdminControllerguruPrograms extends guruAdminController{
	...
	function getcoursecost(){
		include_once(JPATH_SITE.DS."administrator".DS."components".DS."com_guru".DS."js".DS."ajax.php");
		die();
	}
	...
	function addcourse_ajax(){
		include_once(JPATH_SITE.DS."administrator".DS."components".DS."com_guru".DS."js".DS."ajaxExercices.php");
		die();
	}
	...
	function saveOrderG(){
		include_once(JPATH_SITE.DS."administrator".DS."components".DS."com_guru".DS."views".DS."gurudays".DS."tmpl".DS."saveOrderG.php");
		die();
	}
	
	function saveOrderS(){
		include_once(JPATH_SITE.DS."administrator".DS."components".DS."com_guru".DS."views".DS."gurudays".DS."tmpl".DS."saveOrderS.php");
		die();
	}
	
	function deleteScreen(){
		include_once(JPATH_SITE.DS."administrator".DS."components".DS."com_guru".DS."views".DS."gurudays".DS."tmpl".DS."deleteScreen.php");
		die();
	}
	
	function check_values(){
		include_once(JPATH_SITE.DS."administrator".DS."components".DS."com_guru".DS."views".DS."guruprograms".DS."tmpl".DS."ajax.php");
		die();
	}
