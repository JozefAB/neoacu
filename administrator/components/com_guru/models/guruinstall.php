...
class guruAdminModelguruinstall extends JModelLegacy {
	...
	function startDefaultValues(){
		...
		if(!isset($template_emails["chek_quiz_subject"])){
			...
			$template_emails["feedback_subject"] = "Teacher has added or modified the 'Teacher Feedback on Quiz Results'";
			$template_emails["feedback_body"] = "<p>Hello [STUDENT_FIRST_NAME],</p>\r\n<p>A teacher has added feedback to your Quiz: [QUIZ_NAME] results:</p>\r\n<p>\"[FEEDBACK_FIRST_20_WORDS]...\"</p>\r\n<p>You can see the entire feedback here: [LINK_TO_QUIZ_RESULT]</p>\r\n<p>Regards,<br />[SITE_NAME] Administrators</p>";
