...
class guruAdminModelguruConfig extends JModelLegacy {
	...
	function store () {
		...
		$quiz_status = JRequest::getVar("quiz_status", "0");
		...
		elseif($tab == "5"){
			...
			$template_emails["new_student_subject"] = JRequest::getVar('new_student_subject', '', 'post', 'string', JREQUEST_ALLOWRAW);
			$template_emails["new_student_body"] = JRequest::getVar('new_student_body', '', 'post', 'string', JREQUEST_ALLOWRAW);
			...
			$template_emails["chek_quiz_subject"] = JRequest::getVar('chek_quiz_subject', '', 'post', 'string', JREQUEST_ALLOWRAW);
			$template_emails["chek_quiz_body"] = JRequest::getVar('chek_quiz_body', '', 'post', 'string', JREQUEST_ALLOWRAW);
			$template_emails["feedback_subject"] = JRequest::getVar('feedback_subject', '', 'post', 'string', JREQUEST_ALLOWRAW);
			$template_emails["feedback_body"] = JRequest::getVar('feedback_body', '', 'post', 'string', JREQUEST_ALLOWRAW);
			$template_emails["review_quiz_subject"] = JRequest::getVar('review_quiz_subject', '', 'post', 'string', JREQUEST_ALLOWRAW);
			$template_emails["review_quiz_body"] = JRequest::getVar('review_quiz_body', '', 'post', 'string', JREQUEST_ALLOWRAW);
			$template_emails["new_student_enrolled_subject"] = JRequest::getVar('new_student_enrolled_subject', '', 'post', 'string', JREQUEST_ALLOWRAW);
			$template_emails["new_student_enrolled_body"] = JRequest::getVar('new_student_enrolled_body', '', 'post', 'string', JREQUEST_ALLOWRAW);
