		...
		<table class="table table-striped  table-bordered  adminlist">
			...
			?>
				<tr class="row<?php echo $k;?>"> 
                    ...
                    <td align="center">
						<a class="modal" href="<?php echo JURI::root(); ?>index.php?option=com_guru&view=guruOrders&task=showrec&orderid=<?php echo intval($id); ?>&tmpl=component&user_reques=<?php echo intval($order["userid"]); ?>" rel="{handler: 'iframe', size: {x: 700, y: 500}}">
