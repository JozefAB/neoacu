...
<script type="text/javascript" language="javascript">
	...
	function addMoreAnswersSingle(){
		...
		content = '<input type="radio" name="correct_ans[]" id="answ'+current+'" value="'+current+'"><span class="lbl"></span>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="" id="ans'+current+'" name="ans_content['+(current+1)+'][]">&nbsp;&nbsp;&nbsp;<button id="button_media_answers_'+(current+1)+'" onclick="accessMediaIframe(\'iframe_media_list_ans_'+(current+1)+'\'); return false;" class="btn btn-primary"><?php echo JText::_("GURU_ATTACH_MEDIA"); ?></button><div id="ans_media_'+(current+1)+'"></div><br /><div style="display:none;" id="iframe_media_list_ans_'+(current+1)+'"><iframe width="100%" height="350px;" frameborder="0" src="index.php?option=com_guru&amp;controller=guruMedia&amp;tmpl=component&amp;page_from=answers&radio_value='+(current+1)+'" id="media_list_for_questions_answ"></iframe></div>';
	...
	function addMoreAnswersMultiple(){
		...
		content = '<input type="checkbox" name="correct_ans[]" id="answ'+current+'" value="'+current+'"><span class="lbl"></span>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="" id="ans'+current+'" name="ans_content['+current+'][]">&nbsp;&nbsp;&nbsp;<button id="button_media_answers_'+current+'" onclick="accessMediaIframe(\'iframe_media_list_ans_'+current+'\'); return false;" class="btn btn-primary"><?php echo JText::_("GURU_ATTACH_MEDIA"); ?></button><div id="ans_media_'+current+'"></div><br /><div style="display:none;" id="iframe_media_list_ans_'+current+'"><iframe width="100%" height="350px;" frameborder="0" src="index.php?option=com_guru&amp;controller=guruMedia&amp;tmpl=component&amp;page_from=answers&radio_value='+current+'" id="media_list_for_questions_answ"></iframe></div>';
...
<form  method="post" name="adminForm" id="adminForm" action="index.php" onsubmit="validateForm('<?php echo $question_type;?>'); return false;"> 
	<button class="gbtn-success pull-right" onclick="addquestion(<?php echo $_GET['cid'][0].','.$ins_id;?>);"><?php echo JText::_("GURU_SV_AND_CL"); ?></button>
	<button class="gbtn-success pull-right" onclick="document.adminForm.task.value='savequestionandkeep';"><?php echo JText::_("GURU_SAVE"); ?></button>
    	...
    	<div style="width:60%; float:left; margin-right:20px;">
            ...
            <div id="g_media_list">
           	...
           	<div style="margin-top:20px;">
            	<button class="btn btn-primary" id="media_button_for_question" onclick="accessMediaIframe('iframe_media_list'); return false;"><?php echo $button_label; ?></button>
            </div>
            <div id="iframe_media_list" style="display:none;">
            	<iframe id="media_list_for_questions" frameborder="0" src="index.php?option=com_guru&controller=guruMedia&tmpl=component&page_from=question" width="100%" height="350px;"></iframe>
            </div>
        </div>
    ...
    <?php
		...
		?>
			...
			<div style="width:45%; float:left;">
                    ...
                    <?php
                        ...
                        foreach($array_elements as $key=>$value){
                            ...
                            $content_to_display .= '<div class="clearfix">
                                                        ...
                                                        <input type="text" name="ans_content['.$radio_value.'][]" id="ans'.$key.'" value="'.$value["answer_content"].'" />&nbsp;&nbsp;
                                                        <button class="btn btn-primary" id="button_media_answers_'.$radio_value.'" onclick="accessMediaIframe(\'iframe_media_list_ans_'.$radio_value.'\'); return false;">'.$value["label"].'</button>
														<div id="ans_media_'.$radio_value.'">
															'.@implode(" ", $value["media"]).'
														</div>
														<br />
                                                        <div id="iframe_media_list_ans_'.$radio_value.'" style="display:none;">
                                                            <iframe id="media_list_for_questions_answ" frameborder="0" src="index.php?option=com_guru&controller=guruMedia&tmpl=component&page_from=answers&radio_value='.$radio_value.'" width="100%" height="350px;"></iframe>
                                                        </div>
                                                    </div>';
                        }
				...
				<input type="button" onclick="javascript:addMoreAnswersSingle();" class="btn btn-primary" value="<?php echo JText::_("GURU_ADD_MORE"); ?>" />
		...
		?>
			...
			<div style="width:45%; float:left;">
				...
				<input type="button" onclick="javascript:addMoreAnswersMultiple();" class="btn btn-primary" value="<?php echo JText::_("GURU_ADD_MORE"); ?>" />
