...
<br /><br />
<div>
    <form id="adminForm" name="form1" action="index.php?option=com_guru&controller=guruPrograms&task=addmedia&tmpl=component&cid[]=<?php echo $_GET['cid'][0];?>" method="post">
