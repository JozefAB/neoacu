...
<script language="javascript" type="text/javascript">		
	...
	function checkIfCanChnageCommission(){
		...
		if(original_commission != selected_commission){
			var req = new Request.HTML({
				async: false,
				method: 'get',
...
<?php
	...
	$db = JFactory::getDBO();
	$sql = "SELECT `name` FROM #__guru_program WHERE `author` like '%|".intval(JRequest::getVar("id","0","get","int"))."|%' and id IN (SELECT distinct `idcourse` from #__guru_kunena_courseslinkage)";
