	...
	<td colspan="2">
        ...
        <tr>
			...
			<td>
				...
				?>
				<div style="float:left;">
					<input type="text" style="width:50px;" value="<?php echo $_row->width; ?>" name="width_u" id="width"/> x
                	<input type="text" style="width:50px;" value="<?php echo $_row->height; ?>" name="height_u" id="height"/> px &nbsp;
                </div>
