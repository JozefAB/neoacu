...
<form id="adminForm" name="adminForm" action="index.php?option=com_guru&controller=guruTasks&task=addtext&txt=<?php echo $_GET['txt'];?>&tmpl=component&cid[]=<?php echo $_GET['cid'][0];?>" method="post">
