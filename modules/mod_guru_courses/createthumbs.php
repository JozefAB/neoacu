...
if(! defined('FILE_CACHE_SUFFIX') )					define ('FILE_CACHE_SUFFIX', '-img.txt');	// What to put at the end of all files in the cache directory so we can identify them
if(! defined('FILE_CACHE_DIRECTORY') )				define ('FILE_CACHE_DIRECTORY', '../../cache/guru_thumbs');	// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
class timthumb {
	...
	public function __construct(){
		...
		$cachePrefix = 'tb-' . $w_name . $h_name . $z_name;
	...
	protected function serveWebshot(){
		...
		//Very important we don't allow injection of shell commands here. URL is between quotes and we are only allowing through chars allowed by a the RFC C11
